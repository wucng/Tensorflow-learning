...
"""
def images_to_tfrecord(image_filenames,record_location,img_pixel_h=32,img_pixel_w=32,channels=3):
...
if __name__=="__main__":
    ...
    images_to_tfrecord(train_img_filenames,'./output2/training-images/training-images')
    images_to_tfrecord(test_img_filenames, './output2/testing-images/testing-images')
